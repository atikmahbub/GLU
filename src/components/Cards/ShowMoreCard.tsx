...
const ShowMoreCard: FC<IShowMoreCard> = ({ current, total, paddingTop }) => {
    ...
    return (
        <Grid container alignItems="center" className={classes.root}>
            ...
            <Typography className={classes.text}>{current} of {total}</Typography>
        </Grid>
    )
}
...
export default memo(ShowMoreCard)
