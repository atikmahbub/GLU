    ...
    return (
        <div className="main_container">
            ...
            <div className="main_container_dashboard">
                ...
                <div className="row">
                    <div className="col-md-6 main_container_dashboard_col1 bg-white">
                    ...
                    <div className="col-md-6 main_container_dashboard_col2 p-0">
                ...
                <div className="row">
                    ...
                    {/* start */}
                    <div className="col-md-6 main_container_dashboard_col4 bg-white p-0">
                        <div className="main_container_dashboard_card_subtitle">
                            <Link to="" style={{ color: 'blue' }}>
                                See upcomming
                            </Link>
                        </div>
                        <Typography className="main_container_dashboard_card_title">Thursday 30th July 2020</Typography>
                        <div className="row main_container_dashboard_card_subtext">
                            <div className="col-5">
                                <div>45min</div>
                            </div>
