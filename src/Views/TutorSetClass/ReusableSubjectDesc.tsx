            ...
            <div className="col-md-12">
                            ...
                            <div className="sub_rows">
                                <div className="input_row">
                                    <div className="input_text">
                                        <TextField className="line-input-large" label="No. Of Students" fullWidth />
                                    </div>
                                    <div className="input_text">
                                        <TextField className="line-input-large" label="Price per student" fullWidth />
                                    </div>
                                </div>
                            </div>
                        )}
                ...
                <div className="row">
                    <div className="col-md-11 p-0">
                        <TextField className="line-input-large" label="Title (45 Characters)" fullWidth />
                    </div>
                    <div className="col-md-11 p-0">
                        <div className="description_container">
                            <Typography className="title">Description</Typography>
                            <textarea rows={5}  style={{ fontSize:'2.625rem', width: '100%' }} className="textbox" />
