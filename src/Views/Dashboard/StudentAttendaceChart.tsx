...
export const StudentAttendaceChart = () => {
    return (
        <>
            <div className="heading">
                <Typography className="head-text">Student Attendace</Typography>
            </div>
            <div className="revenue-content">
                <div className="revenue-week-stat">
                    <div className="col-md-3">
                        <Typography className="sub-text ">Present Student</Typography>
                    ...
                    <div className="col-md-3">
                        <Typography className="sub-text ">Absent Student</Typography>
                        <Typography className="revenue-count">
                            <span
